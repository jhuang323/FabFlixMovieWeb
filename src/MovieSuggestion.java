...
//			}
			...
			//prepare statement
			PreparedStatement movieSuggestStatement = conn.prepareStatement(queryMovSuggest);
			...
			while(movieSuggestResultSet.next()){

				JsonObject jsonTitleIdObj = generateJsonObject(movieSuggestResultSet.getString("id"),movieSuggestResultSet.getString("title"));
