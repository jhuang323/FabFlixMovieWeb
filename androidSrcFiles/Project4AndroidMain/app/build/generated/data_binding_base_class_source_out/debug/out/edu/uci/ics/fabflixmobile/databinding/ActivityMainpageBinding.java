...
public final class ActivityMainpageBinding implements ViewBinding {
  ...
  private ActivityMainpageBinding(@NonNull ConstraintLayout rootView,
      @NonNull ConstraintLayout container, @NonNull TextView message, @NonNull EditText query,
      @NonNull Button querybutton, @NonNull TextView title) {
  ...
  public static ActivityMainpageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainpageBinding((ConstraintLayout) rootView, container, message, query,
          querybutton, title);
    }
